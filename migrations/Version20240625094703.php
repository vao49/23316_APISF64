 ...
 */
final class Version20240625094703 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livre (id INT AUTO_INCREMENT NOT NULL, auteurs_id INT NOT NULL, isbn VARCHAR(17) NOT NULL, tite VARCHAR(100) NOT NULL, INDEX IDX_AC634F99AE784107 (auteurs_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
